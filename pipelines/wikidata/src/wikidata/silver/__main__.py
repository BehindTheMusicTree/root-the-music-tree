...
import wikidata
from wikidata.silver.canonical_parents import MANUAL_CANONICAL_PARENTS_PATH, flag_canonical_parents
...
canonical_hierarchy_path, _ = prune_genre_hierarchy(canonical_parents_path, silver_dir)
